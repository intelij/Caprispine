...
<div class="main-outer" style="width: 98%; margin: auto; overflow-x: hidden;">
    ...
    <div class="logo-mg"><img src="{{asset('public/upload/images/capriLogo.png')}}" style="width: 300px;float: left;position: absolute;padding: 8px 0px;/* left: 21%; */"></div>
    <div class="address" style="    text-align: right;float: left;margin-top: 20px;margin-left: 334px;">
    <h2 style=" color: #5d6492; font-style: italic; font-weight: 600; margin-bottom: 8px;">Capri Spine Clinic</h2>
    ...
    <div class="container pad-none">
     ...
     <li  style="display: inline-block; width: 270px; font-size: 18px;">Regd. No :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><i>{{$registration_no}}</i></b> </li>
      <li  style="display: inline-block; padding: 0 0px 0 0; font-size: 18px;">Receipt No. : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><i>{{$id}}</i></b> </li>
     </ul>

     <p style="line-height:28px;">Received with thanks from : <b>{{$name}} </b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rs : <b>@if($amount) {{$amount}} /-  ({{convertNumberToWord($amount)}}) @endif by {{$payment_type}} </b><br/>
     Cheque/ Ref. No. : <b>{{$reference_no}}</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bank : <b>{{$bankName}}</b></br>
     on Account of &nbsp;&nbsp;&nbsp;&nbsp;<b> @if($treatment_days) {{$treatment_days}} @else 1 @endif </b>&nbsp;&nbsp;&nbsp;&nbsp;  days <b>‎ Physiotherapy </b> Treatment.</p>
