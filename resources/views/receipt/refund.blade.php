...
<div class="main-outer" style="width: 98%; margin: auto; overflow-x: hidden;">
    ...
    <p style="font-size: 17px; padding: 0; margin: 0; font-weight: 600;">E: info@caprispine.com ! : www.caprispine.com</p>
    </div>
    </section>
    ...
    <div class="container pad-none">
     ...
     <p style="line-height:28px;">Refunded to <b>{{$getData->name}}</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Rs : <b>@if($getData->amount) {{$getData->amount}} /-  ({{convertNumberToWord($getData->amount)}}) @endif by {{ucfirst($getData->payment_type)}} </b><br/>
