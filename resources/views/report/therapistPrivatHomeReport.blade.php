    ...
    <div class="row">
        <div class="col-md-12">
	        ...
	        <div class="box box-info">
	            ...
	            <!-- /.box-header -->
	            <!-- form start -->
	            <form class="form-horizontal" method="post" action="{{url('search-therapist-report')}}">
	            	{{ csrf_field() }}
	              <div class="box-body">
	              ...
	              <table id="example1" class="table table-bordered table-striped dataTable">
	                <thead>
		                <tr>
		                  ...
		                  <th>Staff Collection (SC)</th>
		                  <th>Therapist Collection (TC)</th>
		                  <th>Capri Collection(CC)</th>
	                ...
	                <tbody>
	                	@if($allData)
		                	@foreach($allData as $item)
			                	<tr>
			                	  <td>{{userDetails($item->id)->name}} 
			                	  	@if(($item->service_type == 1) || ($item->service_type == 8) || ($item->service_type == 9))  
			                	  		<b><i>(PHC)</i></b>
			                	  	@endif
			                	  </td>
				                  <td>{{$item->TWD}}</td>
