    ...
    <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="{{url('update-patient/')}}/{{$allData->id}}" enctype="multipart/form-data">
            	{{ csrf_field() }}
	              <div class="box-body">
	              		...
	              		<div class="col-md-3 font-normal">
	              			<select class="form-control select2" name="service" required>
	              				...
	              				@if($service)
	              					...
	              					<option value="{{$sItem->id}}" {{$allData->service_type == $sItem->id ? 'selected="selected"' : ''}}>{{$sItem->name}}</option>
	              					@endforeach
	              				@endif
	              			</select>
	              		</div>
